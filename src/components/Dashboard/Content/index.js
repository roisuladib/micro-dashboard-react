...
const Content = ({ title, subTitle, children }) => {
   return (
      <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
         <div className="sticky z-10 top-0 h-16 border-b shadow-md bg-white lg:py-2.5">
            <div className="px-6 flex items-center justify-between space-x-4 2xl:container">
               <h5 hidden className="text-2xl text-gray-600 font-medium lg:block">Dashboard</h5>
               <button className="w-12 h-16 -mr-2 border-r lg:hidden">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 my-auto hover:stroke-cyan-500 hover:transform hover:scale-125 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <div className="px-4 md:px-6 pt-10 2xl:container">
            <div className="flex flex-col">
               ...
               <p className="text-lg font-normal c-4 mt-1">
                  {subTitle}
               </p>
               <>
                  {children}
